...
void extracted_convolution(int32_t *_kernel, void *_input, int32_t *_conv, int32_t _18, int32_t _222){
    for (int _conv_s1_y = 0; _conv_s1_y < 0 + 62; _conv_s1_y++)
    {
     for (int _conv_s1_x = 0; _conv_s1_x < 0 + 62; _conv_s1_x++)
     {
      ...
      for (int _conv_s1_r__y = 0; _conv_s1_r__y < 0 + 3; _conv_s1_r__y++)
      {
       int32_t _226 = _conv_s1_r__y * 3;
       int32_t _227 = _conv_s1_r__y + _conv_s1_y;
       int32_t _228 = _227 * _18;
       int32_t _229 = _228 + _223;
       for (int _conv_s1_r__x = 0; _conv_s1_r__x < 0 + 3; _conv_s1_r__x++)
       {
...
void extracted_output(int32_t *_conv, void * _output, int32_t _29){
    for (int _output_s0_y = 0; _output_s0_y < 0 + 62; _output_s0_y++)
    {
     int32_t _253 = _output_s0_y * _29;
     int32_t _254 = _output_s0_y * 62;
     for (int _output_s0_x = 0; _output_s0_x < 0 + 62; _output_s0_x++)
     {
      int32_t _255 = _output_s0_x + _254;
      int32_t _256 = _conv[_255];
      uint8_t _257 = (uint8_t)(_256);
      int32_t _258 = _output_s0_x + _253;
      ((uint8_t *)_output)[_258] = _257;
     } // for _output_s0_x
    } // for _output_s0_y
}
...
int conv_3_3(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_47)
 {
  ...
  if (!_97)   {
   int32_t _98 = _25 + _24;
   int32_t _99 = _98 + -1;
   int32_t _100 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 0, 0, 61, _24, _99);
   return _100;
  }
  bool _101 = 0 <= _25;
  if (!_101)   {
  ...
  if (!_106)   {
   ...
   int32_t _108 = _107 + -1;
   int32_t _109 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 1, 0, 61, _27, _108);
   return _109;
  }
  bool _110 = 0 <= _28;
  if (!_110)   {
  ...
  }
  {
   ...
   _kernel[8] = 15;
   {
    ...
    for (int _conv_s0_y = 0; _conv_s0_y < 0 + 62; _conv_s0_y++)
    {
     ...
     for (int _conv_s0_x = 0; _conv_s0_x < 0 + 62; _conv_s0_x++)
     {
    ...
    extracted_convolution(_kernel, _input, _conv, _18, _222);

    bool _239 = 0 <= _27;
    int32_t _240 = _28 + _27;
    bool _241 = _240 <= 62;
    bool _242 = _239 && _241;
    if (!_242)     {
     int32_t _243 = _28 + _27;
     int32_t _244 = _243 + -1;
     int32_t _245 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 61, _27, _244);
     return _245;
    }
    bool _246 = 0 <= _24;
    int32_t _247 = _25 + _24;
    bool _248 = _247 <= 62;
    bool _249 = _246 && _248;
    if (!_249)     {
     int32_t _250 = _25 + _24;
     int32_t _251 = _250 + -1;
     int32_t _252 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 61, _24, _251);
     return _252;
    }
    // produce output
    // consume conv
     ...
     * Dandelion function extraction
     */
    extracted_output(_conv, _output, _29);
    // for (int _output_s0_y = 0; _output_s0_y < 0 + 62; _output_s0_y++)
    // {
    //  int32_t _253 = _output_s0_y * _29;
    //  int32_t _254 = _output_s0_y * 62;
